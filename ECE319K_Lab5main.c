...
const char EID1[] = "JH77847"; // replace abc123 with your EID
const char EID2[] = "AP64772"; // replace abc123 with your EID
...
const uint8_t SinWave[32] = {
  6,19,22,24,27,28,30,31,31,31,30,
...
//const uint32_t Inputs[12]={0, 1, 2, 4, 8, 16, 17, 23, 24, 25, 30, 31};
uint32_t Testdata;
...
int main5(void){// main5
  ...
  Sound_Start(6378); // start one continuous wave
  while(1){
  }
}
uint32_t last,key;
...
void SysTick_Handler(void){
    ...
    DAC5_Out(SinWave[sinIndex]);
    sinIndex = (sinIndex + 1) & 0x1F;
}
